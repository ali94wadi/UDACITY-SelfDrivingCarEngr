...
class Track:
    ...
    def __init__(self, meas, id):
        ...
        ############
        pos_sens = np.ones((4, 1)) # 4x1 homogeneous coord
        ...
        P_vel = np.diag(np.array([params.sigma_p44**2,params.sigma_p55**2,params.sigma_p66**2]))
        self.P = np.zeros((6, 6))
...
class Trackmanagement:
    ...
    def handle_updated_track(self, track):      
        ...
        ############
        track.score += 1./params.window # inrease track score
